<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="Arts.aspx.vb" Inherits="Events_Arts" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
     <div class="btn-group">
        ...
        <!-- dropdown menu links -->
        <li class="active"> <a href="./Arts.aspx">Iowa Arts Festivle</a></li>
               ...
               <div id="section1" class="panorama-section tile-span-2">
                 ...
                 <br />
                  ...
                  <a class="tile app bg-color-purple" href="./icons.html">
                   ...
                   <a class="tile app bg-color-greenDark" href="./icons.html">
                     <div class="image-wrapper">
                        <span class="icon icon-brush" ></span>
                     </div>
                     <span class="app-label">Artists</span>
                  </a>
