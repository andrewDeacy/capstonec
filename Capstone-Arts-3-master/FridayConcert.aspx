<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="FridayConcert.aspx.vb" Inherits="Events_FridayConcert" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
     <div class="btn-group">
        ...
        <li class="active"><a href="./FridayConcert.aspx">Friday Night Concert Series</a></li>
    ...
    <h1>Friday Night Concert Series</h1>
        <div class="container">
      <div class="row">
